...
suite('test the "syntax parser"',function(){
	...
	test('test the data generation',function(done){
		...
		assert.equal(pathData[0].type,'value','the first chunk should be a value with type "value"');
		...
		assert.equal(pathData[1].type,'param','the second chunk should be a param with type "param"');
		...
		assert.equal(pathData[2].type,'param','the third chunk should be an optional param of type "param"');
		...
		assert.equal(pathData[3].type,'splat','the fourth chunk should be an optional splat of type "splat"');
		...
		assert.equal(pathData[4].type,'splat','the fifth chunk should be an optional splat of type "splat"');
